...
const NavBar: React.FC = () => {
    return (
        <nav className="mt-2 bg-gray-800 p-4 rounded-tr-lg">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 flex items-center justify-between">
                ...
                <div className="flex items-center">
                    {/* Amount button */}
                    <button className="bg-gray-700 text-white px-4 py-2 rounded-full mr-4 flex items-center">
                        ₹1,000,000
                    ...
                    {/* Wallet button */}
                    <button className="bg-purple-600 text-white px-4 py-2 rounded-full ml-4">
                        Wallet
                    </button>
                    {/* Notification icon */}
                    <div className="ml-4">
